...
_CONFIG_DEFINITIONS = {
    ...
    'DB_PORT': (int, 'Database', 5432),
    'DB_NAME': (str, 'Database', 'tautulli'),
    'DB_USER': (str, 'Database', 'tautulli'),
    'DB_PASSWORD': (str, 'Database', ''),
    'DB_SSLMODE': (str, 'Database', 'prefer'),
    'DB_POOL_SIZE': (int, 'Database', 5),
    'DB_MAX_OVERFLOW': (int, 'Database', 10),
    'DB_POOL_TIMEOUT': (int, 'Database', 30),
